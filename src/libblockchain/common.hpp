...
#define MINER_EMISSION_REWARD_PERCENT    25
#define AUTHOR_EMISSION_REWARD_PERCENT   25
#define CHANNEL_EMISSION_REWARD_PERCENT  25
#define STORAGE_EMISSION_REWARD_PERCENT  25

#define AUTHOR_SPONSORED_REWARD_PERCENT  40
#define CHANNEL_SPONSORED_REWARD_PERCENT 40
#define STORAGE_SPONSORED_REWARD_PERCENT 20

using coin = publiqpp::coin;

#define CHANNEL_AMOUNT_THRESHOLD    coin(100000, 0)
#define STORAGE_AMOUNT_THRESHOLD    coin(1000, 0)
